    ...
    return (
        <div className='bg-white shadow-lg rounded-sm p-8 pb-12 mb-8'>
            ...
            <div className='grid grid-cols-1 gap-4 mb-4'>
                <textarea
                    ref={commentElement}
                    className='p-4 outline-none w-full rounded-sm focus:ring-2 focus:ring-gray-200 bg-gray-100 text-gray-700'
                    placeholder="Comment"
                    name='comment'
                />
            </div>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4'>
                <input
                    type='text'
                    ref={nameElement}
                    className='py-2 px-4 outline-none w-full rounded-sm focus:ring-2 focus:ring-gray-200 bg-gray-100 text-gray-700'
                    placeholder='Name'
                    name='name'
                />
                <input
            ...
            <div className='mt-8'>
                <button
                    ...
                    className='transition duration-500 ease hover:bg-indigo-900 inline-block bg-pink-400 text-lg rounded-full text-white px-8 py-3 cursor-pointer'
                >
                    Post Comment
                </button>
